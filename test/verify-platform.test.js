...

{
  ...
  assert.match(result.stdout, /"type":"WorkNodeCompleted"/);
  assert.match(result.stdout, /"path":"platform\.status"/);
  assert.match(result.stdout, /GoalVerification:/);
  assert.match(result.stdout, /"type":"GoalVerification"/);
