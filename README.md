...
| GUIDE_CONTRIBUTEUR | Guide d'accueil 3 points, `publish_date` 2026-09-10 | **Terminé** | [#28](https://github.com/Lucid-Project-Official/aerys-eval-sandbox/pull/28) |

## Guide contributeur

Le [guide d'accueil contributeur](CONTRIBUTING.md) est publié le **2026-09-10** (3 points : introduction, onboarding, normes communautaires).

État projet mesurable (`project-state.json`) :
...
Vérification locale : `npm run verify-contributor-guide`
