...
|----------|-------------|--------|-----|
| GUIDE_CONTRIBUTEUR | Guide d'accueil contributeur en 3 points, publié le 2026-09-10 | **Terminé** | [#18](https://github.com/Lucid-Project-Official/aerys-eval-sandbox/pull/18) |
