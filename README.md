...
| PLATEFORME | Développement plateforme, status ready | **Terminé** | `project-state.json` · `npm run verify-platform` |
...
npm run verify-platform           # plateforme développée + platform.status ready
```
